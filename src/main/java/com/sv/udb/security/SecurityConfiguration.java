...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter{
    ...
    public void configAuthentication(AuthenticationManagerBuilder auth) throws Exception {
		...
		.authoritiesByUsernameQuery("select acce_usua, nomb_perm from usuarios, permisos, permisos_usuarios where permisos_usuarios.codi_usua = usuarios.codi_usua and permisos_usuarios.codi_perm = permisos.codi_perm and acce_usua=?");
    ...
    protected void configure(HttpSecurity http) throws Exception {
      ...
      http.authorizeRequests()
        ...
        .antMatchers("/db/**").access("hasRole('ROLE_ADMIN') and hasRole('ROLE_EDITOR')")
